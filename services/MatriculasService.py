...
class MatriculasService:
    ...
    def buscar_matricula(codigo: int) -> ListaMatriculasDto:
        ...
        infos = MatriculasService.__buscar_infos_matricula(
            int(matricula_achada['codAluno']),
    ...
    def __buscar_infos_matricula(codAluno: int, codModalidade: int, qtdAulas: int) -> Any:
        ...
        cidade_nome = CidadeService.buscar_cidade(CidadeService, int(aluno['aluno']['codCidade']))['descricao']
    ...
    def buscar_tabela_matriculas() -> List[Any]:
        ...
        for matricula in matriculas:
            ...
            infor = matriculaService.__buscar_infos_matricula(
                int(matricula['codAluno']),
    ...
    def listar_todas_matriculas() -> List[ListaOrdenadaMatriculasDto]:
        ...
        for matricula in matriculas:
            nome_professor: str = ProfessoresService.buscar_professor_por_modalidade(
                ProfessoresService, int(matricula["matricula"]["codModalidade"])
            ).nome
            elemento = ListaOrdenadaMatriculasDto(
                int(matricula["matricula"]["codigo"]),
                matricula["infos"]["aluno"]["nome"],
                matricula["infos"]["cidade"],
                matricula["infos"]["modalidade"],
                nome_professor,
